# Generated by Django 2.2.10 on 2022-12-22 21:15
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('last_sent_succeed', models.BooleanField(blank=True, db_index=True, null=True)),
        ...
        migrations.CreateModel(
            name='SendMailTaskExceptionLogModel',
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('exception_type', models.CharField(db_index=True, max_length=255, verbose_name='Exception Type')),
                ...
                ('task_batch', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='exception_log', to='webmail.SendMailTaskBatchModel')),
            ],
            options={
        ...
        migrations.CreateModel(
            name='SendMailTaskErrorRecipientModel',
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('recipient', models.EmailField(db_index=True, max_length=254, verbose_name='Recipient Email')),
                ('code', models.PositiveIntegerField(verbose_name='Code')),
                ('response', models.TextField(verbose_name='SMTP Response')),
                ('task_batch', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='error_recipients', to='webmail.SendMailTaskBatchModel')),
            ],
            options={
        ...
        migrations.AddField(
            model_name='sendmailtaskbatchmodel',
            name='task',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='task_batch_list', to='webmail.SendMailTaskModel'),
        ),
        migrations.CreateModel(
